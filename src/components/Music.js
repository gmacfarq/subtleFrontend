        ...
        <div className="links">
          ...
          <div className="sites">
            <a href="https://open.spotify.com/artist/60LsU7GzzmpYrDCLOUZOv4?si=7_0NZ25PR3OLZmr6R4RVqg"
              ...
              <img className="site" src={`./images/spotify.webp`} alt="spotify" />
            </a>
            <a href="https://music.apple.com/us/artist/subtle-orange/1276389179"
            rel='noreferrer' target="_blank">
              <img className="site" src={`./images/apple.webp`} alt="apple" />
            </a>
            ...
            rel='noreferrer' target="_blank">
              <img className="site" src={`./images/youtube.webp`} alt="youtube" />
            </a>
            <a href="https://subtleorange.bandcamp.com/"
            rel='noreferrer' target="_blank">
              <img className="site" src={`./images/bandcamp.webp`} alt="bandcamp" />
            </a>
          </div>
        </div>
